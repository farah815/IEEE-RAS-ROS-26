...
## Video
📹 [Watch the explanation video here](<!-- paste your YouTube/Drive link -->)

The video covers: how the robot was launched, what links and joints mean, what the TF tree shows, the role of `robot_state_publisher` and `joint_state_publisher`, the modification made, and an explanation of 3 links and 3 joints.

## Files in this Folder
- `07-physics.urdf` — the modified URDF file
- `README.md` — this file
- `screenshots/` — RViz, TF tree, `/tf`, `/joint_states`, and `ros2 topic list` screenshots
